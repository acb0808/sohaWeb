...
var players, imitations, scoresDiv, resetButton;
...
function init() {
	...
	scoresDiv.style = "position: fixed; left: 50%; top: 0; transform: translate(-50%, 0); margin-top: 5px; white-space: pre; font-family: Freesentation-9Black;";
	container.appendChild(scoresDiv);
    scoresDiv.innerHTML = "Copyright 2024. 이석현 All rights reserved.";

    var subBar = document.createElement("div");
    subBar.style = "position: fixed; left: 50%; bottom: 0; transform: translate(-50%, 0); margin-top: 5px; white-space: pre; font-family: Freesentation-9Black;";
    subBar.innerHTML = `<input type="checkbox" name="checkbox" id="checkbox"><label for="checkbox">슬로우</label>`;
